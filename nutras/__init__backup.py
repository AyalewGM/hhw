...
app.config['MAIL_USERNAME'] = 'info@hamrishealthandwellness.com'
app.config['MAIL_PASSWORD'] = 'Yirgalem1!'
...
def message_sender(df, registration=False):#, 'addis_mul@gmail.com'
    ...
    df = styler(df)
    msg = Message(msg_raw, sender = 'akotetcenter@rerunas.com', recipients = ['ayalew.mersha@gmail.com','addis.megun@gmail.com', 'addisbk@gmail.com', 'takethiopia@gmail.com', 'aberraamde@gmail.com','addiszelalem651@yahoo.com'])
    msg.html = df
    mail.send(msg)
    return "Message sent!"
